        ...
        const shops = await Shop.insertMany([
            {
                ...
                category: 'Grocery',
                address: 'Main Street Region, Sample City',
                location: { type: 'Point', coordinates: [77.2090, 28.6139] }, // Generic coords
                rating: 4.8,
                distanceKm: 0.5,
            ...
            },
            {
                ...
                category: 'Dairy',
                address: 'Near Police Colony, Sample City',
                location: { type: 'Point', coordinates: [77.2100, 28.6145] },
                rating: 4.6,
                distanceKm: 0.8,
                deliveryAvailable: true,
                deliveryCharge: 15,
            ...
            },
            {
                ...
                address: 'Lake Road, Sample City',
                location: { type: 'Point', coordinates: [77.2050, 28.6120] },
                rating: 4.2,
                distanceKm: 1.2,
            ...
            },
            {
                ...
                category: 'Grocery',
                address: 'Highway Road, Sample District',
                location: { type: 'Point', coordinates: [77.1900, 28.6100] },
                rating: 4.5,
                distanceKm: 2.1,
                deliveryAvailable: true,
                deliveryCharge: 30,

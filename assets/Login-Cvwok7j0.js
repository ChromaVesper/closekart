import{r as D,u as Gn,g as Kn,j as p,L as gt}from"./index-DL7ZgiQD.js";import{a as qn}from"./authService-49wGq_lS.js";const Jn=()=>{};var _t={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function w(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function lr(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(w())}function hr(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function ur(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function dr(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function fr(){const n=w();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function pr(){try{return typeof indexedDB=="object"}catch{return!1}}function mr(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)==null?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lt(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Sn(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(En(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Pn(e))return"Blackberry";if(Rn(e))return"Webos";if(vn(e))return"Safari";if((e.includes("chrome/")||Tn(e))&&!e.includes("edge/"))return"Chrome";if(Cn(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function En(n=w()){return/firefox\//i.test(n)}function vn(n=w()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Tn(n=w()){return/crios\//i.test(n)}function Sn(n=w()){return/iemobile/i.test(n)}function Cn(n=w()){return/android/i.test(n)}function Pn(n=w()){return/blackberry/i.test(n)}function Rn(n=w()){return/webos/i.test(n)}function ht(n=w()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Zi(n=w()){var e;return ht(n)&&!!((e=window.navigator)!=null&&e.standalone)}function Qi(){return fr()&&document.documentMode===10}function kn(n=w()){return ht(n)||Cn(n)||Rn(n)||Pn(n)||/windows phone/i.test(n)||Sn(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function An(n,e=[]){let t;switch(n){case"Browser":t=Lt(w());break;case"Worker":t=`${Lt(w())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${_e}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
